...
export default function Page({ }) {
    ...
    const payForData = [
        ...
        { title: "150 People", amount: 150 },
        { title: "100 People", amount: 100 },
        { title: "50 People", amount: 50 },    
        { title: "Custom" },
    ]
            ...
            <div class="container">
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-md-10">
                        ...
                        <h3 class="head-1">ISKCON Annadan Program</h3>

                            <h2 class="head-1">Help Us Feed the Needy</h2>
                            ...
                            <div class="col-lg-4 pe-xl-4">
                                <div class="donate-img">
                                    <figure class="up-right">
                                        <img src={`/donateForIMGs/ffl.png`} alt="" /></figure>
                                </div>
