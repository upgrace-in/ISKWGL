...
export default function Page({ }) {
    ...
    const payForData = [
        { title: "1 month (4 cows)", amount: 8116 },
        { title: "1 month (2 cows)", amount: 4116 },
        { title: "15 days (4 cows)", amount: 4116 },
        { title: "15 days (2 cows)", amount: 2116 },
        { title: "1 week (4 cows)", amount: 2116 },
        { title: "1 week (2 cows)", amount: 1116 },
        { title: "4 days (4 cows)", amount: 1116 },
        { title: "4 days (2 cows)", amount: 516 },  
        { title: "Custom" },
    ]
            ...
            <div className="container">
                <div className="row d-flex justify-content-center mb-5">
                    <div className="col-md-10">
                        <div id="scrollToDonationForm" className="heading">
                            <h2 className="head-1">Go Seva</h2>
                ...
                <div className="form-wrap my-5 fw-form">
                    <form id="donateForm" onSubmit={(e) => {
                            ...
                            handleDonateClick(e.target.amount.value, "Go Seva-"+title, "Go Seva");
                        }}>
                        <div className="row align-items-start">
                            <div className="col-lg-4 pe-xl-4">
                                <div className="donate-img">
                                    <figure className="up-right">
                                        <img src={`/headerImages/go-seva.jpeg`} alt="" /></figure>
                                </div>
