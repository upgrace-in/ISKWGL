...
export default function FestivalAnnaDaan({ }) {
    ...
    const donationoptions = [
        ...
        { title: "AnnaDaan(For 400 People)", price: 10016},
        { title: "AnnaDaan(For 500 People)", price: 12516}
    ]
    ...
    return (
        <>
            ...
            {/* <section className="hero-section">
                <div className="hero-overlay">
                    ...
                    <div className="hero-content">
                        <p className="hero-title">Festival Anna Daan</p>
            ...
            <div className="container">
                ...
                <div className="donation-card-wrapper" ref={donationRef}>
