...
export default function PinSpacer() {
    ...
    // IMAGE ARRAY
    const imageArray = ["headerImages/narsimha-chaturdasi-poster.jpeg", "headerImages/temple_renovation_1.png", "headerImages/temple_renovation_2.png", "headerImages/temple_renovation_3.png", "headerImages/temple_renovation_4.png", "headerImages/volunteer.png", "/headerImages/Chant-and-Be-happy-min.png", "/headerImages/Sunday-Program-min.png"]
    ...
    return (
        ...
        {imageArray.map((src, index) => (
             ...
             <div className="CarouselContainer">
                 {src === "headerImages/narsimha-chaturdasi-poster.jpeg" ? (
                     <a href="/narsimha-chaturdasi">
