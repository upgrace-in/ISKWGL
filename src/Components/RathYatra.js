...
export default function RathYatra({ params, defaultReferral }) {
    ...
    const payForData = [
        { title: "Jagannath Seva (Annadana for 250 People)", amount: 25116 },
        { title: "Baladeva Seva (Annadana for 150 People)", amount: 15116 },
                ...
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-md-10">
                        <div id="scrollToDonationForm" class="heading">
                            <h2 class="head-1">RATH YATRA DONATION</h2>
                            ...
                            <div class="col-lg-4 pe-xl-4">
                                <div class="donate-img">
                                    <figure class="up-right">
                                        <img src={`/donateForIMGs/Rath-yatra.png`} alt="" /></figure>
                                </div>
