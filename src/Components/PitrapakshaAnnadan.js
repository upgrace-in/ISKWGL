...
export default function PitruPaksha({ params, defaultReferral }) {
    ...
    const payForData = [
        { title: "Prasadam Seva for 5 Devotees ", amount: 516, imagePath: '/donateForIMGs/PPAnnadan.jpeg'},
        { title: "Prasadam Seva for 10 Devotees", amount: 1116, imagePath: '/donateForIMGs/PPAnnadan.jpeg'},
        { title: "Prasadam Seva for 20 Devotees", amount: 2116, imagePath: '/donateForIMGs/PPAnnadan.jpeg'},
        { title: "Prasadam Seva for 30 Devotees", amount: 3116, imagePath: '/donateForIMGs/PPAnnadan.jpeg'},
    ];
                ...
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-md-10">
                        <div id="scrollToDonationForm" class="heading">
                            <h2 class="head-1">PITRUPAKSHA ANNADAN SEVA</h2>
