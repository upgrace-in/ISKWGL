...
export default function GitaJayanti({ params, defaultReferral }) {
    ...
    const payForData = [
        { title: "4 Bhagavad Gita", amount: 1116, imagePath: '/donateForIMGs/GJ.jpeg'},
        { title: "10 Bhagavad Gita", amount: 2516, imagePath: '/donateForIMGs/GJ.jpeg'},
        { title: "20 Bhagavad Gita", amount: 5116, imagePath: '/donateForIMGs/GJ.jpeg'},
        { title: "40 Bhagavad Gita", amount: 10116, imagePath: '/donateForIMGs/GJ.jpeg'},
    ];
                ...
                <div className="row d-flex justify-content-center mb-5">
                    <div className="col-md-10">
                        <div id="scrollToDonationForm" className="heading">
                            <h2 className="head-1">GITA JAYANTI SEVA OPPORTUNITIES</h2>
                            ...
                            <div className="col-lg-8 mt-lg-0 mt-4 ">
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-part"><label for="">Donate For</label><select
