...
export default function NityaSeva({ params, defaultReferral }) {
    ...
    const payForData = [
        { title: "Archana Seva", amount: 116, imagePath: '/donateForIMGs/nityaseva.jpeg'},
        { title: "Pushpalankar Seva", amount: 416, imagePath: '/donateForIMGs/nityaseva.jpeg'},
        { title: "Milk Naivedyam Seva", amount: 516, imagePath: '/donateForIMGs/nityaseva.jpeg'},
        { title: "Sarva Seva", amount: 1116, imagePath: '/donateForIMGs/nityaseva.jpeg'},
    ];
                ...
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-md-10">
                        <div id="scrollToDonationForm" class="heading">
                            <h2 class="head-1">NITYA SEVA OPPORTUNITIES</h2>
