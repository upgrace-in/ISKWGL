...
export default function AccordionItem(props) {
    // Default to true/show if props.open is not specified
    ...
    return (
        <div className="accordion-item">
            <h2 className="accordion-header" onClick={clicked}>
                <button type="button" aria-expanded={isOpen} className="accordion-button">
            ...
            {/* Force display inline based on state */}
            <div 
                        ...
                        {props?.data?.map((d, i) => (
                            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-3" key={i}>
                                <a href={d?.src ? d.src : `/donate/${d?.title}/0`}>
                                    ...
                                    <span className="icon">
                                        <svg className="donate-arrow" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em">
