                        ...
                        <div className="footer-content always-dark">
                            ...
                            <div className="footer-details">
                                <p>
                                    ...
                                    <br />Sringar Darshan - 08:00 am
                                    <br />Raj Bhoga Aarati - 12:30 pm
                                    <br />Uthapana Aarati - 04:30 pm
                                    <br />Sandhya Aarati - 07:00 pm
                            ...
                            <div className="footer-details">
                                ...
                                <br />
                                <a target="_blank" href="/extras/TermsAndConditions.html">Terms and Conditions</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="footer-content first-dark">
                            ...
                            <div className="footer-details">
                                ...
                                <a target="_blank" href="https://maps.app.goo.gl/pCYGwBeL9qbxCarM7">
                                    <p>
                                        ISKCON Temple, Sri Sri Radha NilMadhava mandir, ISKCON
                                        Warangal,<br />
                                        Beside Vajra Gardens,Mulugu Road
                                        Paidipally, Warangal <br />Telangana 506 007
                                    </p>
                                </a>
                            </div>
                            ...
                            <div className="social-links">
                                ...
                                </svg></a><a target="_blank" href="https://www.youtube.com/@hktv108"><svg stroke="currentColor"
                                    fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="1em" width="1em"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                </svg></a><a target="_blank" href="https://www.instagram.com/iskconwarangal"><svg
