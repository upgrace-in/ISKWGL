...
export default function DonateCategories() {
    ...
    return (
        <>
            <section className="campaign-main-sec py-5" id="annadan">
                <div className="container">
                    ...
                    <div className="row align-item-center">
                        <div className="col-lg-12">
                            <div className="donate-bars-wrap">
                                <div className="donate-bar mt-0">
                                    <div className="first">
                                        <h4>AnnaDaan for 50 people</h4>
                                    </div>
                                    <div className="mid"><span>₹1,500</span></div>
                                    <div className="last">
                                        <a onClick={() =>handleDonateClick(1500, "AnnaDaan for 50 People", "AnnaDaan")} className="custom-btn-cls box-hover w-100 h-100"><svg className="me-2" width="24"
                                ...
                                <div className="donate-bar mt-0">
                                    ...
                                    <div className="last">
                                        <a href={`/donate/General Donation Amount of your Choice/0`} className="custom-btn-cls box-hover w-100 h-100"><svg
                                            className="me-2" width="24" height="24" viewBox="0 0 512 512">
                                            <g id="#000000ff">
            ...
            <section className="donate-new" id="donate">
                <div className="container">
                            ...
                            <AccordionItem
                                ...
                                data={
                                    [
                                        ...
                                        { title: "Festival Seva" },
                                        { title: "Food For Life", src:"/AnnaDaan" },
