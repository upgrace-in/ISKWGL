...
export default function ShastraDaan({ params, defaultReferral }) {
    ...
    const payForData = [
        { title: "3 Bhagavad Gita", amount: 750, imagePath: '/donateForIMGs/shastraDaan.jpeg',},
        { title: "11 Bhagavad Gita", amount: 2750, imagePath: '/donateForIMGs/shastraDaan.jpeg'},
        { title: "21 Bhagavad Gita", amount: 5250, imagePath: '/donateForIMGs/shastraDaan.jpeg'},
        { title: "51 Bhagavad Gita", amount: 12750, imagePath: '/donateForIMGs/shastraDaan.jpeg'},
        { title: "101 Bhagavad Gita", amount: 25250, imagePath: '/donateForIMGs/shastraDaan.jpeg'},
    ];
                ...
                <div class="row d-flex justify-content-center mb-5">
                    <div class="col-md-10">
                        <div id="scrollToDonationForm" class="heading">
                            <h2 class="head-1">SHASTRA DAAN SEVA OPPORTUNITIES</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-part"><label for="">Amount*</label><input type="text"
                                            name="amount" onChange={(e) => setAmount(e.target.value)} value={amount} defaultValue={amount} placeholder="Enter Amount" readOnly/></div>
                                    </div>
                                    <div class="col-md-6">
